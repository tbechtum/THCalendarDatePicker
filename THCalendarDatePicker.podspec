Pod::Spec.new do |s|
  ...
  s.source       		= { :git => "https://github.com/tbechtum/THCalendarDatePicker", :tag => "v#{s.version}" }
  s.platform     		= :ios, '9.0'
  s.requires_arc 		= true
  s.header_mappings_dir	= 'THCalendarDatePicker'
  s.source_files 		= 'THCalendarDatePicker/*.{h,m}'
  s.resources 	 		= ['THCalendarDatePicker/*.xib', 'THCalendarDatePicker/Media.xcassets']
  s.frameworks   	 	=  'QuartzCore'
  s.dependency 			'KNSemiModalViewController_hons82', '~> 0.4.6'
